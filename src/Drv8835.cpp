/*
 *  Srv8835.cpp - DRV8835 DC motor driver library.
 ...
 * begin
 ****************************************************************************/
void Drv8835Class::begin(uint8_t m, uint8_t e0, uint8_t p0, uint8_t e1, uint8_t p1)
{
  pinMode(mode, OUTPUT);
 ...
 * begin - mode fixed
 ****************************************************************************/
void Drv8835Class::begin(uint8_t e0, uint8_t p0, uint8_t e1, uint8_t p1)
{
  enable0 = e0;
  phase0  = p0;
  enable1 = e1;
